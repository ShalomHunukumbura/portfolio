...
title: "Coders at work, reflections on the craft of proramming",
author: "Peter Seibel",
note: "Real life interviews of famous developers"
}
    ],
    articles: [
      {
...
"Learned that effective product design starts by identifying real user activities and designing around how people actually accomplish their goals.",
"Learned that most of the real effort in software is hidden beneath the surface like an iceberg, so since non-technical stakeholders judge progress and quality mainly by what they see on the screen, developers must manage expectations, communicate clearly, and control how visible progress is presented."
    ],
    built: [
